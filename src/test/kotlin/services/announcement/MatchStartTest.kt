...
class MatchStartTest {
    ...
    fun interpret() {
        ...
        cut.handleGameEvent("2020-08-30T18:43:06Z", startRoundMessage("123"), repo) shouldContain
            Announcement.MATCH_START
        ...
        cut.handleGameEvent("2020-08-30T19:00:00Z", startRoundMessage("222"), repo) shouldContain
            Announcement.MATCH_START
