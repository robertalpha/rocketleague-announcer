...
class SampleMapperTest {
    ...
    fun testPrevailingNoMapping() {
        sampleMapper.getPrevailingAnnouncement(
            setOf(Announcement.KILL, Announcement.KILLED, Announcement.COMBO_BREAKER)
        ) shouldBe null
    }
    ...
    fun testPrevailingSingleMapping() {
        sampleMapper.getPrevailingAnnouncement(
            setOf(Announcement.KILLED, Announcement.FIRST_BLOOD)
    ...
    fun testPrevailingMultipleMapping() {
        sampleMapper.getPrevailingAnnouncement(
            setOf(Announcement.KILLED_BY_BOT, Announcement.FIRST_BLOOD)
