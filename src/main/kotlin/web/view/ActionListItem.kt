...
fun HtmlBlockTag.actionListItem(actionItem: Pair<Instant, StatMessage>, hashCode: Long) {
    div {
        ...
        div {
            classes = setOf("inline-flex","items-center","text-base","font-semibold","text-gray-900","dark:text-white")
